                                ...
                                <div className='slice_forgetPasswordForm'>
                                    <form onSubmit={handleSubmit} noValidate>
                                        ...
                                        <div className='password_field_div'>
                                            ...
                                            <input className='col-12' type={passwordShown ? "text" : "password"} placeholder='Password' 
                                            name='password'
                                            autoComplete="off"
                                            onChange={handleChange}
                                            />
                                        ...
                                        <div className='password_field_div'>
                                            <FontAwesomeIcon icon={faLock} />
                                            <input className='col-12' type={confirmpasswordShown ? "text" : "password"} placeholder='Confirm Password' 
                                            name='cpassword'
                                            autoComplete="off"
                                            onChange={handleChange}
                                            />
                                            <div className="icon" onClick={handleCheckConfirmPassword}>
